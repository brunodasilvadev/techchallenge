using TechChallenge.CadastroContato.Contract.Contato.Alterar.Message.Validacao;
using TechChallenge.CadastroContato.Language;

namespace TechChallenge.CadastroContato.UnitTests.Contato.Validator
{
    public class AlterarContatoEventMessageValidatorUnitTest : UnitTestBase
    {
        ...
        public async Task DadoArgumentosCorretos_ValidarEventMessageContato_RetornoValido()
        {
            ...
            var validator = new AlterarContatoEventMessageValidator();
